...
AI_PROMPT_TEMPLATE = os.environ.get('AI_PROMPT_TEMPLATE', '''# 结构生物学研究可行性分析报告生成器
...
AI_PROMPT_TEMPLATE_EN = os.environ.get('AI_PROMPT_TEMPLATE_EN', '''# Structural Biology Research Feasibility Analysis Report Generator
