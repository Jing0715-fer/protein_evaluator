...
You are a professional protein structure biologist and bioinformatics expert. Based on the following protein data, generate a **comprehensive and in-depth analysis report**.

## Report Requirements:
1. **Word Count**: Total report should be at least 4000 words
2. **Language**: English
3. **Structure**: Follow the format below, with detailed sections
4. **References**: Cite data sources when possible
...
#### 1.2 Sequence Composition Features
- [e.g., rich in certain amino acids, special repeat sequences, transmembrane region prediction, etc.]
- **Secondary Structure Prediction**: [Based on sequence analysis]
- **Post-translational Modification Sites**: [If related data available or based on sequence pattern prediction]

#### 1.3 Function Description
[Direct quote or description if available]

#### 1.4 Keywords
[List keywords or state "Not available"]

### Part 2: PDB Structure Analysis

#### 2.1 Structure Overview
- **PDB ID**: [PDB ID]
- **Experimental Method**: [Method]
- **Resolution**: [Resolution] Å
- **Chain Composition**: [Chain information]

#### 2.2 Structure Quality Assessment
- **Overall Quality**: [Based on resolution and experimental method]
- **R-free Value**: [If available]
- **Ramachandran Plot**: [If available]

#### 2.3 Chain Composition
- **Chain A**: [Description]
- [Add more chains if available]

### Part 3: Detailed Structure Analysis

#### 3.1 Binding Site Analysis
- **Active Sites**: [If available]
- **Key Residues**: [List important amino acids]
- **Interaction Networks**: [Hydrogen bonds, hydrophobic interactions, ionic bonds, etc.]

#### 3.2 Ligand/Cofactor Analysis
If small molecule ligands exist, analyze in detail; otherwise, state this.

- **Ligand List**: [List all ligands, ions, cofactors]
- **Binding Site Location**: [Describe which region/domain the ligand binds to]
- **Key Interacting Residues**: [Based on structural analysis]
- **Functional Significance**: [Discuss the role of the ligand in protein function]

#### 3.3 Structural Features
- **Overall Conformation**: [e.g., "active state", "inactive state", "apo state", "complex with G protein", etc.]
- **Unique Structural Features**: [If any special features exist]
...
### 4.1 BLAST Search Results Overview
...
### 4.2 Structural Alignment with Target Protein

If BLAST results include other structures of the target protein (from same UniProt):

**Homologous Structure List**:

| PDB ID | Similarity | Species | Structure State/Function |
|--------|-----------|------|------------------------|
| [PDB ID] | [Similarity] | [Species] | [Description] |

**Conservation Analysis**:
[Based on sequence similarity to infer structural and functional conservation]

---

## Part 5: Literature and Disease Associations

### 5.1 Related Publications
[PubMed links and key findings]

### 5.2 Disease Associations
[Any known disease associations with this protein]

### 5.3 Drug Targets
[Any known drug targets or therapeutic implications]

---

## Appendix: Data Sources

- Individual evaluation reports (protein structure-function analysis)
- UniProt metadata
- PDB structure database
